...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # Remember to call dice() exactly num_rolls times 
    # even if Sow Sad happens in the middle of rolling.
    # By doing so, you will correctly simulate rolling all the dice together
    # and the user interface will work correctly.

    sow_sad = False
    all_dice = [dice() for i in range(num_rolls)]
    if 1 in all_dice:
        sow_sad = True
